...
export class LocaldbService {
  ...
  initializeCredentials() {
    const users = {
      ...
      alumno: { email: 'alumno@duocuc.cl', password: 'duoc2024', nombre: 'Jose Vasquez', rol: 'alumno', institucion: 'DuocUC' },
      profesor: { email: 'profesor@profesor.duoc.cl', password: 'duoc2024', nombre: 'Luis Morales', rol: 'profesor', institucion: 'DuocUC' },
